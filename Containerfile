...
RUN rpm-ostree update --uninstall rpmfusion-free-release-$(rpm -E %fedora).noarch --uninstall rpmfusion-nonfree-release-$(rpm -E %fedora).noarch --install rpmfusion-free-release --install rpmfusion-nonfree-release

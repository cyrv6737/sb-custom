...
RUN rpm-ostree uninstall rpmfusion-free-release-$(rpm -E %fedora)-1.noarch rpmfusion-nonfree-release-$(rpm -E %fedora)-1.noarch --install=rpmfusion-free-release --install=rpmfusion-nonfree-release

...
RUN rpm-ostree uninstall rpmfusion-free-release-$(rpm -E %fedora).noarch rpmfusion-nonfree-release-$(rpm -E %fedora).noarch --install rpmfusion-free-release --install rpmfusion-nonfree-release
